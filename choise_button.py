...
choice = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            ...
            InlineKeyboardButton(text="Прогноз погоди на любий день", callback_data="prognos_historical_date"),
            InlineKeyboardButton(text="Прогноз погоди на 10 днів вперед", callback_data="prognos_forecast_days"),
            ]
    ]
)
