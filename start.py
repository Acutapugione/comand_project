...
async def admin(message: types.Message):
    await message.message.answer(text="Щоб зв'язатися з адміном.\nТелеграм: https://t.me/Phonk_Top_Amor \nДіскорд: amor_top_1")
...
async def some_function_that_needs_user_city(user_city: str):
    ...
    # Iterate through the forecast data and store information for each day
    for day_data in data['data']:
        ...
        # Create a PrognosForecastDays instance for each day and add it to the session
